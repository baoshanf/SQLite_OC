...
+ (void)saveMovie:(TestModel2 *)model{
    ...
    [[DbManager getInstance].dbQueue inDatabase:^(FMDatabase *db) {
        ...
        //新增或替换表信息
        @try{
            BOOL success1 = [db executeInsertOrReplaceInTable:MOVIE_TABLE_NAME
            ...
            //写入
            BOOL success2 = [db executeInsertOrReplaceInTable:MOVIE_ACTOR_TABLE_NAME withParameterDictionary:@{@"film_id" : NULLABLE(model.testmodel3.filmId),
